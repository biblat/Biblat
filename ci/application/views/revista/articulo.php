					...
					<td colspan="2">
                        ...
                        <form id="formSolicitudDocumento2" method="POST" class="contacto">
							<fieldset>
								...
								{_('Los documentos originales pueden ser consultados en el Departamento de Información y Servicios Documentales, ubicado en el Anexo de la Dirección General de Bibliotecas (DGB), circuito de la Investigación Científica a un costado del Auditorio Nabor Carrillo, zona de Institutos entre Física y Astronomía. Ciudad Universitaria UNAM.')} <a id="showmap" href="javascript:;">{_('Ver mapa')}</a><br/><img id="mapa-anexo" style="display:none" src="{base_url('img/mapa-anexo.jpg')}" border="0" width="100%"/><br/>{_('Mayores informes: Departamento de Información y Servicios Documentales, tels.  (+52)  55 56 22 43 99 extensión 49986, (+52) 55 56 22 39 64, (+52)  55 56 22 39 60 con la Dra. Araceli Noguez, e-mail: anoguezo@dgb.unam.mx, sinfo@dgb.unam.mx, Horario: Lunes a viernes (8:00 a 16:00 hrs.)')}<br/><br/></div>
