          ...
          <td>
                ...
                <div class="col-xs-12 col-md-3">
                    <div style="display: flex; align-items: center; justify-content: center">
                        ...
                        <div style="display: inline;"><a href="https://plu.mx/plum/a/?doi={$resultado.doi}" class="plumx-plum-print-popup" data-size="medium" data-popup="bottom" data-hide-when-empty="true" title="PlumX"></a></div>
                    </div>
                </div>
                </div>
          </td>
