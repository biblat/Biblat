...
class_nr = {
    ...
    texto:{
        nucleo: "El Núcleo central de revistas es la colección de revistas actualizadas en BIBLAT durante los últimos 5 años (<anio1> a <anio2>). Se considera que una " +
                ...
                "Para la actualización de una revista, envíenos un correo electrónico a <a href='mailto:biblat_comite@dgb.unam.mx'>biblat_comite@dgb.unam.mx</a> con copia a <a href='mailto:biblat_gestion@dgb.unam.mx'>biblat_gestion@dgb.unam.mx</a>, indícanos el título y la URL de la revista que se requiere actualizar.",
