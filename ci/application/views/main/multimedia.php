	      ...
	      <h5 class="panel-title">
                    <div class="row" id="indicadores">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-8">
                            <a href="https://www.youtube.com/embed/-yduR9vVCuA?si=YPi_KF01dHWGjeTj" target="_blank">
                                <span class="fa fa-youtube-square"></span> Charla - RERCIE: <br>
                                <br>"Biblat: de la indización a la analítica y visibilidad académica"<br>
                                28 abril 2026
                            </a>
                        </div>
                    </div>
	    ...
	    <div class="panel-heading">
	      <h5 class="panel-title">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-8">
                            <a href="https://fb.watch/dxM4X9E5Vs/" target="_blank">
                                <span class="fa fa-facebook-square"></span> 
                                Carrillo Romero, Oralia, Durán Muñoz, Edgar y Sánchez Pereyra, Antonio. (2021, abril). BIBLAT. Ventana de la ciencia latinoamericana y caribeña. Educación Continua DGBSDI-UNAM, México.
                            </a>    
                        </div>
                    </div>
	      </h5>
	    ...
	    <div class="panel-heading">
	      <h5 class="panel-title">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-8">
                            <a href="https://www.youtube.com/embed/WgsELl6Pj7A" target="_blank">
                                <span class="fa fa-youtube-square"></span> 
                                BIBLAT presenta nuevo módulo para que los editores autoevalúen sus revistas con los criterios de evaluación de las bases de datos y sometan su candidatura.
                            </a>    
                            <br><br>IV Jornada LatinREV - Panel II Indización, redes sociales y buscadores bibliográficos académicos: estrategias de las revistas - Exposiciones de H. Degiorgis, C. Authier, A. Sánchez Pereyra y M. A. Chávez Flores - 8/10/2020
                            <br><br>Introducción de Antonio Sánchez, en minuto 42:51
                            <br>Presentación del módulo de Manuel Alejandro Flores, en minuto 52:10
	    ...
	    <div class="panel-heading">
	      <h5 class="panel-title">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-8">
                            <a href="https://www.youtube.com/watch?v=h571rion4vI" target="_blank">
                                <span class="fa fa-youtube-square"></span> Procedimiento para incluir la visualización de los indicadores bibliométricos de BIBLAT en el sitio de la revista
                            </a>
                        </div>
                    </div>
	      </h5>
