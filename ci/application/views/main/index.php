...
{/foreach}
	...
	<div class="col-md-6">					  
        <div class="list-group list-main">
            ...
            <a target="_blank" class="list-group-item"href="{site_url('indicadores/modelo-elitismo')}"><span class="fa fa-line-chart"></span> {_('Modelo de Elitismo')}</a><br><p style="font-size:12px;margin-left:25px;margin-bottom:0px"><i>{_('Cantidad de autores más productivos por revista')}</i></p></a>
