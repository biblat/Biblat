<p>MetaMetrics valida los metadatos a nivel artículo de las revistas publicadas en Open Journal System (OJS). Esta aplicación se basa en el <a href="{base_url('archivos/pdf/manual_indizacion_ojs_2ed.pdf')}" target="_blank">Manual de indización en OJS: Buenas prácticas para la región latinoamericana</a>, el cual constituye un marco de trabajo común para los países de América Latina y el Caribe.</p>
